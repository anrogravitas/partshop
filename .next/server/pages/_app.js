...
function MyApp({ Component , pageProps  }) {
    ...
    (0,external_react_.useEffect)(()=>{
        (async ()=>{
            const scrollCue = (await __webpack_require__.e(/* import() */ 1926).then(__webpack_require__.bind(__webpack_require__, 91926))).default;
            scrollCue.init({
                interval: -400,
                duration: 700,
                percentage: 0.8
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(external_react_.Fragment, {
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)(theme_ThemeProvider, {
                children: [
